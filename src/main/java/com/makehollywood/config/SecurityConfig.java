package com.makehollywood.config;

import com.makehollywood.repository.UserRepository;
import com.makehollywood.security.JwtAuthFilter;
import com.makehollywood.security.JwtTokenProvider;
import com.makehollywood.security.OAuth2SuccessHandler;
import com.makehollywood.service.CustomOAuth2UserService;
    ...
    public SecurityFilterChain webSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .successHandler(oAuth2SuccessHandler)  // ← вместо defaultSuccessUrl
                )
